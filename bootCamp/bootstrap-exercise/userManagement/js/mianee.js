...
function checkedd(){
    let checkSc=$('input:radio[name="inlineRadioOptions2"]:checked').val();
    let useSchool=$('#useSchooll');
    let useCompany=$('#useCompanyy');
    let idl=$('#idll');
...
checkedd();
$('#inlineRadio5,#inlineRadio6').click(function(){
    checkedd();
})